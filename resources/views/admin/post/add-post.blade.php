            ...
            <form action="{{ route('postAddPost')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea style="resize: none" name="short_content" class="form-control" id="ckeditor" rows="8"></textarea>
                  </div>
                  <div class="form-group">
                    <label>Nội Dung:</label>
                    <textarea style="resize: none" name="content" class="form-control" id="ckeditor1" rows="8"></textarea>
                  </div>
                  <div class="form-group">
